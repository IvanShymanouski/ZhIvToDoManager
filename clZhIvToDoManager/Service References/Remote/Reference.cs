...
namespace clZhIvToDoManager.Remote {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Remote.IToDoManager")]
    public interface IToDoManager {
        ...
        clZhIvToDoManager.Remote.ToDoItem[] GetTodoList(int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/GetTodoList", ReplyAction="http://tempuri.org/IToDoManager/GetTodoListResponse")]
        System.Threading.Tasks.Task<clZhIvToDoManager.Remote.ToDoItem[]> GetTodoListAsync(int userId);
        ...
        void UpdateToDoItem(clZhIvToDoManager.Remote.ToDoItem todo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/UpdateToDoItem", ReplyAction="http://tempuri.org/IToDoManager/UpdateToDoItemResponse")]
        System.Threading.Tasks.Task UpdateToDoItemAsync(clZhIvToDoManager.Remote.ToDoItem todo);
        ...
        void CreateToDoItem(clZhIvToDoManager.Remote.ToDoItem todo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/CreateToDoItem", ReplyAction="http://tempuri.org/IToDoManager/CreateToDoItemResponse")]
        System.Threading.Tasks.Task CreateToDoItemAsync(clZhIvToDoManager.Remote.ToDoItem todo);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IToDoManagerChannel : clZhIvToDoManager.Remote.IToDoManager, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ToDoManagerClient : System.ServiceModel.ClientBase<clZhIvToDoManager.Remote.IToDoManager>, clZhIvToDoManager.Remote.IToDoManager {
        ...
        public clZhIvToDoManager.Remote.ToDoItem[] GetTodoList(int userId) {
            return base.Channel.GetTodoList(userId);
        }
        
        public System.Threading.Tasks.Task<clZhIvToDoManager.Remote.ToDoItem[]> GetTodoListAsync(int userId) {
            return base.Channel.GetTodoListAsync(userId);
        }
        
        public void UpdateToDoItem(clZhIvToDoManager.Remote.ToDoItem todo) {
            base.Channel.UpdateToDoItem(todo);
        }
        
        public System.Threading.Tasks.Task UpdateToDoItemAsync(clZhIvToDoManager.Remote.ToDoItem todo) {
            return base.Channel.UpdateToDoItemAsync(todo);
        }
        
        public void CreateToDoItem(clZhIvToDoManager.Remote.ToDoItem todo) {
            base.Channel.CreateToDoItem(todo);
        }
        
        public System.Threading.Tasks.Task CreateToDoItemAsync(clZhIvToDoManager.Remote.ToDoItem todo) {
